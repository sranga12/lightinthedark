...
class Room extends React.Component {
  ...
  render() {
    return (
        ...
        <a-box depth=".5" height=".1" width="1" position="6 1 4" rotation="0 10 0" color="#4CC3D9"></a-box>
        <a-box depth=".5" height=".1" width="1" position="-5 0 -3" rotation="0 10 0" color="#6864BD"></a-box>
