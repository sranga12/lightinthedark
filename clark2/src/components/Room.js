...
class Room extends React.Component {
  ...
  render() {
    var color = this.state.lights_on? "#C4BEB9":"#D91C07";
      ...
      {/*red -- on tv stand*/}
      <Book lii="1" lights={this.state.lights_on} depth=".5" height=".1" width="1" position="9.7 -4 1.5" rotation="4 8 0" color="#96140e"></Book>
      {/*maroon -- on bar/table thing in kitchen*/}
      <Book lii="2" lights={this.state.lights_on} depth=".5" height=".1" width="1" position="0.75 0 -9" rotation="0 30 0" color="#820938"></Book>
      {/*purple -- leaning against wall next to microwave */}
      <Book lii="3" lights={this.state.lights_on} depth=".5" height=".1" width="2.5" position="28 -1.75 -28" rotation="4 8 -120" color="#500D78"></Book>
      {/*blue -- on little black box trunk thingy near front door*/}
      <Book lii="4" lights={this.state.lights_on} depth="1" height=".2" width="2" position="25 -5 23" rotation="4 20 0" color="#2E0B70"></Book>
      {/*ugly brown/orange color -- under foot of bed*/}
      <Book lii="5" lights={this.state.lights_on} depth=".75" height=".2" width="1.25" position="-6.5 -10.5 16" rotation="20 20 0" color="#8A4904"></Book>
      {/*teal -- on the couch*/}
      <Book lii="6" lights={this.state.lights_on} depth=".5" height=".1" width="1" position="-6 -2.2 0" rotation="4 -130 10" color="#25cfaf"></Book>
      {/*peach -- on white ikea bedside table*/}
      <Book lii="7" lights={this.state.lights_on} depth=".7" height=".1" width="1.3" position="8 -5 24" rotation="0 0 0" color="#FFC5AD"></Book>
